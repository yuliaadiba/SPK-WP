...
<head>
  ...
  <body>
		...
		<div class="container">
		  ...
		  <center><font size="6">Data Alternatif</font></center>
										...
										<?php
												...
												while ($row = $alternatif->fetch_assoc()) {
													...
													?>
														  ...
														  <a href="del.php?id=<?php echo $row['id_alternatif'];?>" onClick="return confirm('Yakin ingin menghapus data Alternatif <?php echo $row['alternatif'];?> ?');" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Delete</a></td>
													<?php
													echo '</tr>';
												}
										?>
