	...
	<div id="wrapper">
	  ...
	  <div class="container">
		    ...
		    ?>
		  	...
		  	<center><font size="6">Data Kriteria<br><br></font></center>
			...
			<tbody>
				...
				?>
					<a href="edit-kriteria.php?id=<?php echo $row["id_kriteria"];?>" class="btn btn-secondary btn-sm"><i class="fa fa-pencil"></i> Edit</a>
