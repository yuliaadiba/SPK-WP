...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
	  ...
	  <center><font size="6">Perhitungan</font></center>
	  <br>
	  <br>		
	  <center>
				<?php
					echo "<b>Tabel Alternatif - Bobot Tiap Kriteria</b></br>";
					...
					echo "</table><hr>";
					// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> bobot kepentingan <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< //
					echo "<b>Perhitungan Perbaikan Bobot</b></br>";
					echo "<table class='table table-striped table-bordered table-hover'>";
					echo "<thead><tr><th></th><th>C1</th><th>C2</th><th>C3</th><th>C4</th><th>C5</th><th>Jumlah</th></tr></thead>";
						...
						echo "<td>".$tkep."</td></tr>";
						echo "<tr><td><b>Bobot Perbaikan</b></td>";
						for($i=0;$i<$k;$i++){
							$bkep[$i] = ($kep[$i]/$tkep);
							$tbkep = $tbkep + $bkep[$i];
					...
					uasort($v,'cmp');
								for($i=0;$i<$arl2;$i++){ //new for 8 lines below
									if($i==0)
										echo "<div class='alert alert-dark alert-dark'><b><i> ".$alt_name[array_search((end($v)), $v)]." mempunyai nilai vektor V atau nilai akhir paling tinggi, yaitu ".current($v);
									elseif($i==($arl2-1))
										echo "</br>Maka yang menjadi siswa berprestasi adalah ".$alt_name[array_search((end($v)), $v)].". Karena hanya 1 siswa saja yang terpilih menjadi siswa berprestasi <br> 
										dan akan mendapatkan penghargaan dari pihak sekolah.</i></b></div>";
